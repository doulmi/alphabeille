(function (h, o, g) {
    ...
    g[h] = {
        ...
        settings: {
            ...
            css: ' .audiojs .play { background: url("$1") -2px -1px no-repeat; } .audiojs .loading { background: url("$1") -2px -31px no-repeat; } .audiojs .error { background: url("$1") -2px -61px no-repeat; } .audiojs .pause { background: url("$1") -2px -91px no-repeat; }',
            trackEnded: function () {
            },
            flashError: function () {
