...
class TaskController extends Controller
{
    public function index(Request $request)
    {
        ...
        $videos = $builder->select(['tasks.id', 'video_id', 'videos.slug', 'user_id', 'videos.state', 'videos.avatar', 'title', 'tasks.created_at', 'tasks.updated_at', 'users.name', 'tasks.is_submit'])->orderBy('tasks.updated_at', 'DESC')->paginate(50)->appends($request->all());
