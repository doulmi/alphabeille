...
Route::get('vocabularies', 'VocabularyController@index');
Route::get('vocabularies/loginForm', 'VocabularyController@loginForm');
Route::post('vocabularies/login', 'VocabularyController@login');
Route::get('vocabularies/{hash}', 'VocabularyController@show');
Route::get('vocabularies/check/{token}', 'VocabularyController@check');
...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
  ...
  Route::resource('vocabularies', 'Admin\VocabularyController');
  ...
  Route::get('90days', 'Admin\CheckupController@index');
  Route::get('api/90days/students', 'Admin\CheckupController@students');
  Route::get('90days/students', 'Admin\CheckupController@studentIndex');
  Route::get('90days/students/{name}', 'Admin\CheckupController@studentShow');
  Route::get('90days/students/deleteComment/{name}/{date}', 'Admin\CheckupController@deleteComment');
