...
@section('content')
    ...
    @endif
        ...
        <div class="form-group">
            ...
            @if($edit)
                <input name='title' type="text" class="form-control" id="title" value="{{$talkshow->title}}"/>
            @else
        ...
        <div class="form-group">
            ...
            @if($edit)
                <input type="text" class="form-control" id="avatar" name="avatar" value="{{$talkshow->avatar}}"/>
            @else
        ...
        <div class="form-group">
            ...
            @if($edit)
                <input type="text" class="form-control" id="audio_url" name="audio_url" value="{{$talkshow->audio_url}}"/>
            @else
        ...
        <div class="form-group">
            ...
            @if($edit)
                <input type="text" class="form-control" id="duration" name="duration" value="{{$talkshow->duration}}"/>
            @else
        ...
        <div class="form-group">
            ...
            @if($edit)
                <input type="text" class="form-control" id="likes" name="likes" value="{{$talkshow->likes}}"/>
                @else
        ...
        <div class="form-group">
            ...
            @if($edit)
                <input type="text" class="form-control" id="views" name="views" value="{{$talkshow->likes}}"/>
            @else
